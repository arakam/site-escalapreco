  ...
  return (
    <MarketingLayout>
      <div className="container max-w-3xl py-16 md:py-24">
        <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Política de Privacidade</h1>
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">2. Dados que podemos coletar</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">3. Finalidades</h2>
            <p>

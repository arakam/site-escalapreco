  ...
  return (
    <MarketingLayout>
      <div className="container max-w-3xl py-16 md:py-24">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Termos de Uso</h1>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Uso do site</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">3. Conta e serviços</h2>
            <p>

  ...
  return (
    <MarketingLayout>
      <div className="container max-w-3xl py-16 md:py-24">
        <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Sobre o Escala Preço</h1>
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-10 mb-3">Nossa missão</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-10 mb-3">Para quem é</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-10 mb-3">Contato</h2>
            <p className="leading-relaxed">
